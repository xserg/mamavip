	...
	<div class="mainContainer theLecture">
		<div class="contentWrap">
			...
			<div class="topLine flexWrap">
				...
				<button class="theButton rightButton buttonTransparent buttonFav fontFamilyB"></button>
			</div>
			...
			<div class="contentSubWrap">
				...
				<div class="midWrap desc_box content_box marginB12">
					<p>(Описание лекции идёт сюда) Идейные соображения высшего порядка, а также постоянное информационно-проп...</p>
					<span class="show_more">Подробнее</span>
				</div>

				<div class="userinfo_wrap topWrap marginB12">
					<div class="userinfo_box">
						<router-link class="userinfo_card" to="/teachers/teacher">
